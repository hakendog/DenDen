...
const failures = [];
const banned = /<owner>|<verified-full-commit-sha>|<40 碼完整 commit SHA>|<full 40-character commit SHA>|D:\\workspace\\DenDen|UNLICENSED|尚未發布的本機來源|主要賣點|預發布|本機驗收|刻意保持不可執行/;
